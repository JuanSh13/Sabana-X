<?php
    ...
    class consultasE
    {
        ...
        public function registraUserE($identificacion, $tipodoc, $nombres, $apellidos, $email, $telefono, $clavemd, $rol, $estado){
            ...
            if ($array) {
                ...
                $insertarUser = "INSERT INTO users (identificacion, tipodoc, nombres, apellidos, email, telefono, clave, rol, estado) VALUES (:identificacion, :tipodoc, :nombres, :apellidos, :email, :telefono, :clavemd, :rol, :estado)";
