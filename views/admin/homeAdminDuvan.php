...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__wobble" src="../assets/dist/img/sabana.png" alt="AdminLTELogo" width="400px">
  </div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Duvan Avila</a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="gestionUsuarios/verUsuarios.html" class="nav-link active">
                  <i class="fas fa-eye nav-icon"></i>
                  <p>Ver</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="gestionUsuarios/registrarUsuarios.html" class="nav-link active">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <ul class="chart-legend clearfix">
                          <li><i class="far fa-circle text-danger"></i> Teatro</li>
                          <li><i class="far fa-circle text-success"></i> Cine</li>
                          <li><i class="far fa-circle text-warning"></i> Música</li>
                          <li><i class="far fa-circle text-info"></i> Pintura</li>
