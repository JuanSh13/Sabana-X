	...
	<div class="container-fluid p-0">
		...
		<ul class="navbar-nav mx-auto">
		  ...
		  <li class="nav-item dropdown dropdown-slide">
			<a class="nav-link" href="categorias.html">Categorias<span>/</span></a>
		  </li>
		  <li class="nav-item">
			<a class="nav-link" href="tienda.html">Tienda<span>/</span></a>
		  </li>
		  <li class="nav-item">
			  <a class="nav-link" href="calendario.html">Calendario<span>/</span></a>
			</li>
		  <li class="nav-item dropdown dropdown-slide">
			<a class="nav-link" href="artistas.html" >Artistas
			  <span>/</span>
			</a>
		  </li>
		  <li class="nav-item">
